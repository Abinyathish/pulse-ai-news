...
const SOURCE_COLORS: Record<string, string> = {
  ...
  "The Hacker News": "bg-orange-600",
  "MIT Tech Review": "bg-rose-500",
  "The Information": "bg-amber-500",
  "9to5Google": "bg-green-500",
  "9to5Mac": "bg-gray-500",
};
...
export function SourceFilter({ selectedSources, onSourcesChange }: SourceFilterProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-1.5 w-56 rounded-lg border bg-popover shadow-lg z-50 py-1.5 animate-in fade-in-0 zoom-in-95 max-h-[400px] overflow-y-auto">
          {/* Select All */}
          <button
            onClick={selectAll}
