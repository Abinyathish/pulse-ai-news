...
export function NewsCard({ article }: NewsCardProps) {
  ...
  return (
    ...
    >
      <Card className="p-4 h-full transition-colors group-hover:bg-card/80 dark:group-hover:bg-card/60">
        <div className="flex flex-col gap-3 h-full">
          ...
          {/* Description */}
          <p className="text-xs text-muted-foreground leading-relaxed line-clamp-3 flex-1" data-testid="text-description">
            {article.description}
          </p>

          {/* Bottom: category + read more */}
